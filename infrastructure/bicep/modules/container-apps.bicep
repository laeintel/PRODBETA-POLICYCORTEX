  ...
  properties: {
    ...
    configuration: {
      ...
      secrets: [
        {
          name: 'jwt-secret-key'
          keyVaultUrl: 'https://${keyVaultName}.${environment().suffixes.keyvaultDns}/secrets/jwt-secret-key'
          identity: userAssignedIdentityId
        }
        {
        ...
        }
        {
          ...
          keyVaultUrl: 'https://${keyVaultName}.${environment().suffixes.keyvaultDns}/secrets/storage-account-name'
          identity: userAssignedIdentityId
        }
        {
          name: 'application-insights-connection-string'
          keyVaultUrl: 'https://${keyVaultName}.${environment().suffixes.keyvaultDns}/secrets/application-insights-connection-string'
          identity: userAssignedIdentityId
        }
        {
          name: 'cognitive-services-key'
          keyVaultUrl: 'https://${keyVaultName}.${environment().suffixes.keyvaultDns}/secrets/cognitive-services-key'
          identity: userAssignedIdentityId
        }
        {
          name: 'cognitive-services-endpoint'
          keyVaultUrl: 'https://${keyVaultName}.${environment().suffixes.keyvaultDns}/secrets/cognitive-services-endpoint'
          identity: userAssignedIdentityId
        }
        {
          name: 'redis-connection-string'
          keyVaultUrl: 'https://${keyVaultName}.${environment().suffixes.keyvaultDns}/secrets/redis-connection-string'
          identity: userAssignedIdentityId
        }
        {
