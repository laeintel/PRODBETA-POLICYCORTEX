# PowerShell script to migrate Container Apps to dedicated workload profiles
...
# Configuration - using actual resource group names
$ResourceGroup = "rg-policortex001-app-$Environment"
$ContainerAppsEnvironment = "cae-policortex001-$Environment"

Write-Host "Starting migration of Container Apps to dedicated workload profiles" -ForegroundColor Green
...
# Define workload profile mappings
...
Write-Host ""
Write-Host "Workload Profile Mappings:" -ForegroundColor Cyan
