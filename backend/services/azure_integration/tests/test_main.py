...
class TestPolicyEndpoints:
    ...
    def test_list_policies_with_filters(self, client, auth_headers, mock_policy_service, subscription_id):
        """Test listing policies with filters."""
        with patch("backend.services.azure_integration.main.get_current_user") as mock_user:
            mock_user.return_value = {"id": "test-user"}
            
            response = client.get(
                f"/api/v1/policies?subscription_id={subscription_id}&resource_group=test-rg&policy_type=custom",
                headers=auth_headers
            )
            assert response.status_code == 200
    ...
    def test_get_policy(self, client, auth_headers, mock_policy_service, subscription_id, policy_id):
    ...
    def test_create_policy(self, client, auth_headers, mock_policy_service, subscription_id, policy_request):
    ...
    def test_update_policy(self, client, auth_headers, mock_policy_service, subscription_id, policy_id, policy_request):
    ...
    def test_delete_policy(self, client, auth_headers, mock_policy_service, subscription_id, policy_id):
    ...
    def test_get_policy_compliance(self, client, auth_headers, mock_policy_service, subscription_id, policy_id):
    ...
    def test_policy_endpoint_error_handling(self, client, auth_headers, mock_policy_service, subscription_id):
...
class TestRBACEndpoints:
    ...
    def test_create_role_assignment(self, client, auth_headers, mock_rbac_service, subscription_id, rbac_request):
    ...
    def test_delete_role_assignment(self, client, auth_headers, mock_rbac_service, subscription_id, role_assignment_id):
...
class TestCostEndpoints:
    ...
    def test_get_cost_usage(self, client, auth_headers, mock_cost_service, subscription_id):
        ...
        with patch("backend.services.azure_integration.main.get_current_user") as mock_user:
            ...
            response = client.get(
                f"/api/v1/costs/usage?subscription_id={subscription_id}&start_date=2023-01-01&end_date=2023-01-31",
                headers=auth_headers
            )
            assert response.status_code == 200
            data = response.json()
    ...
    def test_get_cost_recommendations(self, client, auth_headers, mock_cost_service, subscription_id):
...
class TestNetworkEndpoints:
    ...
    def test_list_network_security_groups(self, client, auth_headers, mock_network_service, subscription_id):
    ...
    def test_analyze_network_security(self, client, auth_headers, mock_network_service, subscription_id):
...
class TestResourceEndpoints:
    ...
    def test_list_resource_groups(self, client, auth_headers, mock_resource_service, subscription_id):
...
class TestErrorHandling:
    ...
    def test_global_exception_handler(self, client):
        ...
        with patch("backend.services.azure_integration.main.health_check", side_effect=Exception("Test error")):
            response = client.get("/health")
            assert response.status_code == 500
