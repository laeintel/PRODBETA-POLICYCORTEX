...
class RBACAnalyzer:
    ...
    async def prepare_rbac_data(self, workspace_id: str, days_back: int = 30) -> Dict[str, Any]:
        ...
        | where Category in ("Authentication", "RoleManagement", "UserManagement", "DirectoryManagement")
    ...
    def _process_rbac_data(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        df['permission_id'] = self.encoders['permission'].fit_transform(df['Permission'].fillna('unknown'))
    ...
    def _detect_access_patterns(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        if len(user_features) > 1:
            ...
            patterns['user_clusters'] = {
                ...
                'silhouette_score': silhouette_score(X_scaled, clusters) if len(set(clusters)) > 1 else 0
            }
    ...
    def _analyze_user_roles(self, user_data: pd.Series, rbac_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _analyze_user_permissions(self, user_data: pd.Series, rbac_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _detect_role_conflicts(self, user_data: pd.Series, role_hierarchy: Dict[str, Any]) -> List[str]:
    ...
    async def optimize_role_structure(self, rbac_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'optimization_score': self._calculate_optimization_score(role_usage, redundant_roles)
            }
