...
class NLPService:
    ...
    async def _analyze_compliance(self, text: str, options: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    async def _analyze_security(self, text: str, options: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    async def _analyze_performance(self, text: str, options: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    async def _analyze_governance(self, text: str, options: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    async def _analyze_general(self, text: str, options: Optional[Dict[str, Any]]) -> Dict[str, Any]:
