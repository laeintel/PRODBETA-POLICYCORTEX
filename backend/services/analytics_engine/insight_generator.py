...
class InsightGenerator:
    ...
    async def generate_insights(self,
                              ...
                              correlations: List[Dict]) -> List[Insight]:
        """
    ...
    async def _generate_anomaly_insights(self,
                                       anomalies: List[Dict]) -> List[Insight]:
    ...
    async def _generate_trend_insights(self,
                                     metrics_data: pd.DataFrame) -> List[Insight]:
    ...
    async def _generate_predictive_insights(self,
                                          predictions: Dict[str, Any]) -> List[Insight]:
    ...
    async def get_insight_summary(self) -> Dict[str, Any]:
        ...
        self.insights_cache = [
            ...
            if not i.expires_at or i.expires_at > datetime.utcnow()
        ]
        ...
        for severity in InsightSeverity:
            severity_counts[severity.value] = sum(
                1 for i in self.insights_cache
