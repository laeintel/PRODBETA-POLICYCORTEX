...
class ContextManager:
    ...
    async def update_context(
        ...
        try:
            ...
            current_context["intent_history"] = (
                current_context["intent_history"][-5:]  # Keep last 5 intents
            )
    ...
    async def _update_entity_context(
        ...
        for entity in entities:
            ...
            if entity_value in context["entities"][entity_type]:
                ...
                context["entities"][entity_type][entity_value]["last_seen"] = (
    ...
    async def get_context_for_response(
        ...
        try:
            ...
            intent_context = {
                ...
                "follow_up_expected": context.get(
                    "conversation_state",
                    {}).get("follow_up_expected",
                    False
                ),
                "recent_intents": [
