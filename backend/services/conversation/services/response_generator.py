...
class ResponseGenerator:
    ...
    def _load_response_templates(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "greeting": {
                "system_prompt": "You are a friendly Azure governance assistant. Respond to greetings warmly and
                    offer help.",
                "max_tokens": 200,
                "temperature": 0.8
            },
            "help": {
                "system_prompt": "You are an Azure governance expert. Provide helpful guidance and
                    explain capabilities clearly.",
                "max_tokens": 500,
                "temperature": 0.6
            },
            "cost_analysis": {
                "system_prompt": "You are an Azure cost management expert. Help users understand and
                    optimize their Azure costs.",
                "max_tokens": 800,
                "temperature": 0.5
            },
            "policy_query": {
                "system_prompt": "You are an Azure policy and
                    governance expert. Help users understand and implement Azure policies.",
                "max_tokens": 800,
                "temperature": 0.4
            },
            "resource_management": {
            ...
            "security_analysis": {
                "system_prompt": "You are an Azure security expert. Help users understand and
                    improve their Azure security posture.",
                "max_tokens": 800,
                "temperature": 0.4
            },
            "rbac_query": {
                "system_prompt": "You are an Azure RBAC expert. Help users understand and
                    configure role-based access control.",
                "max_tokens": 800,
                "temperature": 0.4
            },
            "network_analysis": {
                "system_prompt": "You are an Azure networking expert. Help users understand and
            ...
            "general_query": {
                "system_prompt": "You are an Azure governance assistant. Provide helpful information about Azure services and
                    best practices.",
                "max_tokens": 600,
                "temperature": 0.6
            }
    ...
    def _generate_fallback_response(
        ...
        fallback_responses = {
            ...
            ConversationIntent.POLICY_QUERY: "I can help you with Azure policies and
                governance. What specific policy information are you looking for?",
            ...
            ConversationIntent.HELP: "I can help you with Azure governance, costs, policies, resources, and
                security. What would you like to know?",
        }
