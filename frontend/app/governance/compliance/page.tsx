    ...
    <div className="bg-gray-900/50 rounded-lg border border-gray-800 p-6">
      ...
      {!selected ? (
        ...
        <div>
          ...
          <div className="space-y-2">
            {violations.map(v => (
              <div key={v.resource} className="flex items-center justify-between p-3 bg-gray-800/50 rounded">
                <div>
                  <p className="font-medium">{v.policy}</p>
                  <p className="text-sm text-gray-400">{v.resource} • {v.type}</p>
                </div>
      ...
      <div className="space-y-3">
        {items.map(v => (
          <div key={v.resource} className="flex items-center justify-between p-3 bg-gray-800/50 rounded">
            <div>
              <p className="font-medium">{v.policy}</p>
              <p className="text-sm text-gray-400">{v.resource}</p>
            </div>
