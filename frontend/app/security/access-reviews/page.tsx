    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white">
      <div className="border-b border-gray-200 dark:border-gray-800 bg-white/50 dark:bg-gray-900/50 backdrop-blur">
        <div className="max-w-7xl mx-auto px-6 py-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Review and audit access permissions</p>
        </div>
      </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <ActionButton 
                  ...
                  onClick={() => handleExport({
                    data: data,
                    filename: 'access-reviews-report',
                    format: 'json',
                    title: 'Access Reviews Report'
                  })} 
                />
                <ActionButton 
                  label="Configure" 
