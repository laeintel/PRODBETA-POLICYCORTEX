...
export default function EntitlementManagementPage() {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-white">
      <div className="border-b border-gray-200 dark:border-gray-800 bg-white/50 dark:bg-gray-900/50 backdrop-blur">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <h1 className="text-2xl font-bold">Entitlement Management</h1>
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Manage access packages and entitlements</p>
        </div>
      </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <ActionButton 
                  ...
                  onClick={() => handleExport({
                    data: data,
                    filename: 'entitlements-report',
                    format: 'json',
                    title: 'Entitlements Report'
                  })} 
                />
                <ActionButton 
                  label="Configure" 
    ...
    <div className="bg-white dark:bg-gray-900/50 rounded-lg border border-gray-200 dark:border-gray-800 p-4">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-500 mt-1">{trend}</p>
        </div>
...
function ActionButton({ label, onClick }: any) {
  return (
    <button type="button" 
      onClick={onClick}
      className="px-4 py-2 bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-gray-700 rounded text-sm transition-colors">
      {label}
    </button>
  )
}
