  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-400">Environment deployments with details</p>
      </div>
      ...
      <div className="bg-gray-900 rounded-lg border border-gray-800 overflow-hidden">
        <table className="w-full">
          <thead className="bg-gray-800/50 border-b border-gray-800">
            <tr>
              <th className="text-left px-6 py-3 text-sm font-medium text-gray-400">Environment</th>
              <th className="text-left px-6 py-3 text-sm font-medium text-gray-400">Version</th>
              <th className="text-left px-6 py-3 text-sm font-medium text-gray-400">Status</th>
              <th className="text-left px-6 py-3 text-sm font-medium text-gray-400">Deployed</th>
              <th className="text-left px-6 py-3 text-sm font-medium text-gray-400">Action</th>
            </tr>
          </thead>
          <tbody>
            {deployments.map(d => (
              <tr key={d.env} className="border-b border-gray-800 hover:bg-gray-800/50">
